...
<template>
    ...
    <div class="p-12 lg:p-24 pt-16 pb-6">
        <p> Hi Helga,
    ...
    <form @submit.prevent="submit">
        <div class="pr-6 pl-6 lg:pr-24 lg:pl-24">
        ...
        <div class="flex flex-col justify-center p-6 pl-24 pr-24">
